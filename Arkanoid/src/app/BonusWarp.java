...
public class BonusWarp extends Bonus {
    ...
    public BonusWarp(Escenario escenario,double x,double y){
        this.x=x;
        this.y=y;
        ...
        try {
            this.imagen=ImageIO.read(getClass().getResource("imagenes/Warp.gif"));
            this.imagen=imagen.getScaledInstance(ancho,alto, imagen.SCALE_SMOOTH);
        } catch (Exception e) {
            System.out.println("ERROR AL CARGAR IMAGEN BONUS Warp");
        }
    }
